  ...
  return (
    <>
      ...
      <div className="paragraph-main">
        ...
        <br />
        <br />
        <div><img className="paragraph-background" src="/videos/SmashUltimateLogo.gif" id="p-background-2" /></div>
        <p className="paragraph">
        ...
        <br />
        <br />
        <div> <img className="paragraph-background" src="/videos/SmashUltimateLogo.gif" id="p-background-3" /></div>
        <p className="paragraph">
        ...
        <br />
        <br />
        <div><img className="paragraph-background" src="/videos/SmashUltimateLogo.gif" id="p-background-4" /></div>
        <p className="paragraph">
        ...
        <br />
        <br />
        <div><img className="paragraph-background" src="/videos/SmashUltimateLogo.gif" id="p-background-5" /></div>
        <p className="paragraph">
        ...
        <br />
        <br />
        <div> <img className="paragraph-background" src="/videos/SmashUltimateLogo.gif" id="p-background-6" /></div>
        <p className="paragraph">
        ...
        <br />
        <br />
        <div><img className="paragraph-background" src="/videos/SmashUltimateLogo.gif" id="p-background-7" /></div>
        <p className="paragraph">
        ...
        <br />
        <br />
        <div> <img className="paragraph-background" src="/videos/SmashUltimateLogo.gif" id="p-background-8" /></div>
        <p className="paragraph">
