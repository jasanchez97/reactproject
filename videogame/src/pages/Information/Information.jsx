...
function Information() {
  ...
  return (
    <div className="information-container">
      ...
      Brawl fue anunciado personalmente en una conferencia de prensa anterior al E3 respectivo de 2004 por el director ejecutivo en jefe Satoru Iwata. Posteriormente en esa misma noche, se le propuso al director de los dos juegos de la serie Super Smash Bros. previamente lanzados, Masahiro Sakurai, que fuera el director del tercer título; este último aceptó el cargo.<br></br><br></br>
      En octubre de 2005, cuando comenzó el desarrollo del juego, Nintendo ya había pedido la ayuda de varios desarrolladores externos para que trabajaran en una oficina en Tokio exclusiva para el desarrollo de Brawl. El desarrollo del juego comenzó en octubre de 2005 con un equipo que incluyó a miembros de Nintendo y de algunas third party.<br></br><br></br>
      Después de varios retrasos por problemas técnicos, el juego fue finalmente lanzado en Japón el 31 de enero de 2008, el 9 de marzo de 2008 en Norteamérica, el 26 de junio de 2008 en Australia y el 27 de junio de 2008 en Europa. Veintisiete meses después del lanzamiento japonés, el juego fue lanzado en Corea del Sur, el 29 de abril de 2010.<br></br><br></br>
      Como sus predecesores, el objetivo de Brawl es expulsar al oponente fuera de la pantalla. Es un punto de partida de los tradicionales juegos de lucha, en particular en sus simplificados comandos para mover al jugador y el énfasis en tener que expulsar al contrincante del escenario en contra del formato clásico en este tipo de juegos: tener que vaciar la barra de energía del enemigo.<br></br><br></br>
      Incluye un modo de un jugador más extenso que sus predecesores, conocido como El emisario subespacial.<br></br>
      Este modo es un beat 'em up de scroll horizontal, que incluye escenas cinematográficas hechas por ordenador que protagonizan los personajes del juego. Brawl también incluye batallas multijugador de hasta cuatro jugadores, y es el primer juego de la franquicia en hacer uso de la Conexión Wi-Fi de Nintendo. El juego admite hasta cuatro mandos distintos, que son el mando de Wii con el Nunchuk, el mando de Wii individual, el mando clásico y el mando de GameCube.<br></br><br></br>
      Super Smash Bros. Brawl recibió de forma general críticas positivas, recibiendo elogios respecto a su capacidad para entretener, a pesar de las críticas relativas a sus tiempos de carga.<br></br>
